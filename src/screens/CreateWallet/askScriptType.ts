...
import { ScriptType, type ScriptType as ScriptTypeValue } from "../../domain/wallet/Wallet.js";
import { MINIMAL_LIST_THEME } from "../common/promptTheme.js";

export const askScriptType = async (
  defaultValue: ScriptTypeValue = ScriptType.P2pkh,
